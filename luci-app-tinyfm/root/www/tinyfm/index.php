        ...
        <div class="col-xs-12 col-sm-9">
            <ul class="list-inline footer-action">
                ...
                <li class="list-inline-item"><input type="submit" class="hidden" name="zip" id="a-zip" value="zip" onclick="return confirm('<?php echo lng('Create archive?'); ?>')">
                    <a href="#/bulk-zip" onclick="fmBulkArchive('zip');return false;" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-file-archive-o"></i> Zip </a></li>
                <li class="list-inline-item"><a href="#/bulk-unzip" onclick="fmBulkUnzip();return false;" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-folder-open-o"></i> Unzip </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="tar" id="a-tar" value="tar" onclick="return confirm('<?php echo lng('Create archive?'); ?>')">
                    <a href="#/bulk-tar" onclick="fmBulkArchive('tar');return false;" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-file-archive-o"></i> Tar </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="copy" id="a-copy" value="Copy">
                    <a href="javascript:document.getElementById('a-copy').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-files-o"></i> <?php echo lng('Copy') ?> </a></li>
                <li class="list-inline-item"><a href="#/copy-to-legacy" onclick="document.getElementById('a-copy').click();return false;" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-share-square-o"></i> Copy to </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="delete" id="a-delete" value="Delete" onclick="return confirm('<?php echo lng('Delete selected files and folders?'); ?>')">
                    <a href="javascript:document.getElementById('a-delete').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-trash" style="color:#f85149"></i> <?php echo lng('Delete') ?> </a></li>
            </ul>
        </div>
...
<html>
<head>
<script>if(localStorage.getItem('fm_view_mode')==='grid'){document.documentElement.className+=' fm-pregrid';}</script>
<style>html.fm-pregrid #main-table{display:none !important;}</style>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Tiny File Manager">
    <meta name="author" content="CCP Programmers">
    ...
    <style>
        ...
        *,*::before,*::after { box-sizing: border-box;}
        ...
        .inline-actions > a > i { font-size:1em;margin-left:5px;color:#0e7490;padding:3px 4px; }
...
<style>
            ...
            .table-dark { --bs-table-bg: 13, 17, 23 !important; }
            .btn-primary { --bs-btn-bg: #0e7490; --bs-btn-border-color: #0e7490; }
            body.theme-dark { background-image: linear-gradient(90deg, #0d1117, #0d1117); color: #c9d1d9; color-scheme: dark; }
            .list-group .list-group-item { background: #161b22; }
            .theme-dark .navbar-nav i, .navbar-nav .dropdown-toggle, .break-word { color: #c9d1d9; }
            a, a:hover, a:visited, a:active, #main-table .filename a, i.fa.fa-folder-o, i.go-back { color: var(--bg-color); }
            ul#search-wrapper li:nth-child(odd) { background: #161b22; }
            .theme-dark .btn-outline-primary { color: #22d3ee; border-color: #22d3ee; }
            .theme-dark .btn-outline-primary:hover, .theme-dark .btn-outline-primary:active { background-color: #164e63;}
            .theme-dark input.form-control { background-color: #0d1117; color: #c9d1d9; border-color: #30363d; }
            .theme-dark .dropzone { background: transparent; }
            .theme-dark .inline-actions > a > i { color: #22d3ee; }
            .theme-dark .text-white { color: #c9d1d9 !important; }
            .theme-dark .table-bordered td, .table-bordered th { border-color: #30363d; }
            .theme-dark .table-bordered td .custom-control-input, .theme-dark .table-bordered th .custom-control-input { opacity: 0.678; }
            .message { background-color: #161b22; }
            .compact-table tr:hover td { background-color: #161b22; }
            #main-table tr.even { background-color: #111820; }
            form.dropzone { border-color: #0891b2; }
            .theme-dark .card.bg-dark, .theme-dark .card{background-color:#161b22 !important;border:1px solid #30363d;}
            .theme-dark .form-control:focus, .theme-dark input.form-control:focus { border-color: #22d3ee !important; box-shadow: 0 0 0 0.2rem rgba(34,211,238,0.25) !important; }
            .theme-dark .input-group-text { background-color: #0d1117; border-color: #30363d; color: #22d3ee; }
            .theme-dark .btn-outline-secondary { background-color: #0d1117; border-color: #30363d; color: #8b949e; }
            .theme-dark .btn-outline-secondary:hover, .theme-dark .btn-outline-secondary:focus { background-color: #164e63; border-color: #22d3ee; color: #22d3ee; }
            .theme-dark .dropdown-toggle { background-color: #0d1117 !important; border-color: #30363d !important; color: #8b949e !important; }
            .theme-dark .dropdown-menu { background-color: #161b22; border-color: #30363d; }
            .theme-dark .dropdown-menu .dropdown-item { color: #c9d1d9; }
            .theme-dark .dropdown-menu .dropdown-item:hover, .theme-dark .dropdown-menu .dropdown-item:focus { background-color: #0d1117; color: #22d3ee; }
            .theme-dark .dropdown-divider { border-color: #30363d; }
        </style>
    <?php endif; ?>
</head>
...
<div id="snackbar"></div>
<script>
function fmDoUnzip(name){
    var f = document.createElement('form');
    f.method = 'POST'; f.action = '';
    var t = document.createElement('input'); t.type='hidden'; t.name='token'; t.value=window.csrf;
    var u = document.createElement('input'); u.type='hidden'; u.name='unzip'; u.value=name;
    f.appendChild(t); f.appendChild(u);
    document.body.appendChild(f);
    f.submit();
}
function fmBulkArchive(ext){
    var checked = document.querySelectorAll('input[name="file[]"]:checked');
    if(!checked.length){ alert('Belum ada file yang dicentang'); return; }
    if(!confirm('Buat arsip ' + ext + '?')) return;
    ...
    showLocalToast('Membuat arsip ' + ext + '...');
    var path = new URLSearchParams(window.location.search).get('p') || '';
    var body = new URLSearchParams();
    body.set('token', window.csrf);
    body.set('group', '1');
    body.set(ext, '1');
    checked.forEach(function(cb){ body.append('file[]', cb.value); });
    fetch('?p=' + encodeURIComponent(path), {method:'POST', headers:{'Content-Type':'application/x-www-form-urlencoded'}, body: body.toString()})
        .then(function(){
            showLocalToast('Selesai, memuat ulang...');
            window.location.reload();
        }).catch(function(){
            showLocalToast('Gagal membuat arsip');
        });
}
function fmBulkUnzip(){
    var checked = document.querySelectorAll('input[name="file[]"]:checked');
    if(!checked.length){ alert('Belum ada file yang dicentang'); return; }
    var targets = [];
    checked.forEach(function(cb){
        ...
        if(['zip','tar','gz','tgz'].indexOf(ext) !== -1){ targets.push(name); }
    });
    if(!targets.length){ alert('Tidak ada file zip/tar/gz yang dicentang'); return; }
    var btn = document.querySelector('a[href="#/bulk-unzip"]');
    var originalHtml = btn ? btn.innerHTML : '';
    if(btn){ btn.innerHTML = '<i class="fa fa-spinner fa-spin"></i> Extracting...'; btn.style.pointerEvents = 'none'; btn.style.opacity = '0.6'; }
    var toast = document.getElementById('fm-toast');
    function showLocalToast(msg){
        if(!toast) return;
        toast.textContent = msg;
    ...
    showLocalToast('Mengekstrak ' + targets.length + ' file...');
    var path = new URLSearchParams(window.location.search).get('p') || '';
    var tasks = targets.map(function(name){
        var body = new URLSearchParams();
        body.set('token', window.csrf);
        body.set('unzip', encodeURIComponent(name));
        return fetch('?p=' + encodeURIComponent(path), {method:'POST', headers:{'Content-Type':'application/x-www-form-urlencoded'}, body: body.toString()});
    });
    Promise.all(tasks).then(function(){
        showLocalToast('Selesai, memuat ulang...');
        window.location.reload();
    }).catch(function(){
        showLocalToast('Gagal ekstrak, coba lagi');
        if(btn){ btn.innerHTML = originalHtml; btn.style.pointerEvents=''; btn.style.opacity=''; }
    });
}
</script>
<script>
var FM_SETTINGS = {
    ...
    error_report: <?php echo $report_errors ? 'true' : 'false'; ?>,
    show_hidden: <?php echo $show_hidden_files ? 'true' : 'false'; ?>,
    hide_cols: <?php echo $hide_Cols ? 'true' : 'false'; ?>
};
(function(){
    function fmThemeInit(){
        var toolbar = document.querySelector('ul.navbar-nav');
        if(!toolbar) return;
        var li = document.createElement('li');
        li.className = 'nav-item';
        var isDark = FM_SETTINGS.theme === 'dark';
        li.innerHTML = '<a href="#" id="fm-theme-toggle-btn" class="nav-link fm-toggle-grid" title="Toggle theme"><i class="fa ' + (isDark ? 'fa-sun-o' : 'fa-moon-o') + '"></i></a>';
        toolbar.insertBefore(li, toolbar.firstChild);

        document.getElementById('fm-theme-toggle-btn').addEventListener('click', function(e){
            e.preventDefault();
            var target = FM_SETTINGS.theme === 'dark' ? 'light' : 'dark';
            var params = new URLSearchParams();
            params.set('type', 'settings');
            params.set('js-language', FM_SETTINGS.lang);
            if(FM_SETTINGS.error_report) params.set('js-error-report', 'true');
            if(FM_SETTINGS.show_hidden) params.set('js-show-hidden', 'true');
            if(FM_SETTINGS.hide_cols) params.set('js-hide-cols', 'true');
            params.set('js-theme-3', target);
            params.set('token', window.csrf);
    ...
    if(document.readyState === 'complete' || document.readyState === 'interactive'){ setTimeout(fmThemeInit, 300); }
    else { document.addEventListener('DOMContentLoaded', fmThemeInit); }
})();
</script>
<style id="fm-paste-style">
#fm-paste-bar{display:none;align-items:center;gap:6px;background:#0d1117;border:1px solid #22d3ee;border-radius:6px;padding:3px 8px 3px 10px;margin-left:4px;}
#fm-progress{width:60px;height:4px;background:#30363d;border-radius:2px;overflow:hidden;display:none;}
#fm-progress.show{display:block;}
#fm-progress-fill{width:30%;height:100%;background:#22d3ee;border-radius:2px;animation:fmProgressMove 1s linear infinite;}
@keyframes fmProgressMove{0%{margin-left:-30%;}100%{margin-left:100%;}}
#fm-paste-bar button:disabled{opacity:0.5;cursor:not-allowed;}
#fm-paste-bar.show{display:inline-flex;}
#fm-paste-bar .fm-paste-label{color:#c9d1d9;font-size:12px;max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
#fm-paste-bar .fm-paste-label b{color:#22d3ee;}
#fm-paste-bar button{border-radius:5px;padding:3px 10px;font-size:12px;cursor:pointer;border:1px solid #30363d;line-height:1.6;}
#fm-paste-bar .fm-move-btn{background:#0d1117;border-color:#0891b2;color:#22d3ee;}
#fm-paste-bar .fm-move-btn:hover{background:#164e63;}
#fm-paste-bar .fm-paste-btn{background:#0e7490;border-color:#0e7490;color:#e6fff9;}
#fm-paste-bar .fm-paste-btn:hover{background:#0891b2;}
#fm-paste-bar .fm-cancel-btn{background:#0d1117;color:#8b949e;}
#fm-paste-bar .fm-cancel-btn:hover{color:#e24b4a;border-color:#e24b4a;}
#fm-toast{position:fixed;left:50%;bottom:20px;transform:translateX(-50%);background:#134a3d;color:#7ee6c8;border:1px solid #1d7a5f;border-radius:8px;padding:8px 14px;font-size:12px;z-index:9999;opacity:0;transition:opacity .25s;pointer-events:none;}
#fm-toast.show{opacity:1;}
</style>
<script>
(function(){
    function fmPasteInit(){
        var STORE_KEY = 'fm_pending_copy';

        var bar = document.createElement('div');
        bar.id = 'fm-paste-bar';
        bar.innerHTML = '<span class="fm-paste-label">Copy: <b id="fm-paste-name"></b></span>' +
            '<button type="button" class="fm-move-btn" id="fm-move-btn">Move</button>' +
            '<button type="button" class="fm-paste-btn" id="fm-paste-btn">Paste</button>' +
            '<button type="button" class="fm-cancel-btn" id="fm-cancel-btn">Cancel</button>' +
            '<div id="fm-progress"><div id="fm-progress-fill"></div></div>';

        var footerAction = document.querySelector('ul.footer-action');
        if(footerAction){
            var li = document.createElement('li');
            li.className = 'list-inline-item';
            li.appendChild(bar);
            footerAction.appendChild(li);
        } else {
        ...
        function refreshBar(){
            ...
            document.getElementById('fm-paste-name').textContent = data.name;
            bar.classList.add('show');
        }

        function setBusy(busy){
            document.getElementById('fm-move-btn').disabled = busy;
            document.getElementById('fm-paste-btn').disabled = busy;
            document.getElementById('fm-cancel-btn').disabled = busy;
            document.getElementById('fm-progress').classList.toggle('show', busy);
        }
        function goFinish(move){
            var raw = sessionStorage.getItem(STORE_KEY);
            if(!raw) return;
            var data = JSON.parse(raw);
            var toPath = currentPath();
            var isMulti = Array.isArray(data.srcs);

            function buildBody(withMove){
                var body = new URLSearchParams();
                data.srcs.forEach(function(s){ body.append('file[]', s); });
                body.set('copy_to', toPath);
                body.set('finish', '1');
                body.set('token', window.csrf);
                if(withMove){ body.set('move', '1'); }
                return body;
            }

            if(isMulti){
                setBusy(true);
                showToast(move ? 'Memindahkan...' : 'Menyalin...');
                var srcUrl = '?p=' + encodeURIComponent(data.baseDir);
                fetch(srcUrl, {method:'POST', headers:{'Content-Type':'application/x-www-form-urlencoded'}, body: buildBody(move).toString()})
                    .then(function(r){ return r.text(); }).then(function(html){
                        var failed = move ? (html.indexOf('Error while moving') !== -1) : (html.indexOf('Error while copying') !== -1);
                        if(!failed){
                        ...
                        if(!move){
                            sessionStorage.removeItem(STORE_KEY);
                            showToast('Gagal copy, dibatalkan');
                            setBusy(false);
                            window.location.reload();
                            return;
                        }
                        showToast('Beda disk, fallback: copy+delete...');
                        fetch(srcUrl, {method:'POST', headers:{'Content-Type':'application/x-www-form-urlencoded'}, body: buildBody(false).toString()})
                            .then(function(r2){ return r2.text(); }).then(function(html2){
                                if(html2.indexOf('Error while copying') !== -1){
                                    sessionStorage.removeItem(STORE_KEY);
                                    showToast('Gagal total, dibatalkan');
                                    setBusy(false);
                                    window.location.reload();
                                    return;
                                }
                                var delTasks = data.srcs.map(function(s){
                                    var delUrl = '?p=' + encodeURIComponent(data.baseDir) + '&del=' + encodeURIComponent(s);
                                    var b = new URLSearchParams();
                                    b.set('token', window.csrf);
                                    return fetch(delUrl, {method:'POST', headers:{'Content-Type':'application/x-www-form-urlencoded'}, body: b.toString()});
                                });
                        ...
                        showToast('Koneksi gagal/timeout');
                        setBusy(false);
                    });
                return;
            }
            ...
            if(!move){
                setBusy(true);
                sessionStorage.removeItem(STORE_KEY);
                window.location.href = '?p=' + encodeURIComponent(toPath) + '&copy=' + encodeURIComponent(data.src) + '&finish=1';
                return;
            }
            setBusy(true);
            showToast('Memindahkan...');
            var moveUrl = '?p=' + encodeURIComponent(toPath) + '&copy=' + encodeURIComponent(data.src) + '&finish=1&move=1';
            fetch(moveUrl).then(function(r){ return r.text(); }).then(function(html){
                if(html.indexOf('Error while moving') === -1){
                    sessionStorage.removeItem(STORE_KEY);
                    window.location.reload();
                    return;
                }
                showToast('Beda disk, fallback: copy+delete...');
                var copyUrl = '?p=' + encodeURIComponent(toPath) + '&copy=' + encodeURIComponent(data.src) + '&finish=1';
                fetch(copyUrl).then(function(r2){ return r2.text(); }).then(function(html2){
                    if(html2.indexOf('Error while copying') !== -1){
                        sessionStorage.removeItem(STORE_KEY);
                        showToast('Gagal total, dibatalkan');
                        setBusy(false);
                    ...
                    var parts = data.src.split('/');
                    var srcName = parts.pop();
                    var srcDir = parts.join('/');
                    var delUrl = '?p=' + encodeURIComponent(srcDir) + '&del=' + encodeURIComponent(srcName);
                    var body = new URLSearchParams();
                    body.set('token', window.csrf);
                    fetch(delUrl, {method:'POST', headers:{'Content-Type':'application/x-www-form-urlencoded'}, body: body.toString()})
                        .then(function(){
                            sessionStorage.removeItem(STORE_KEY);
                            window.location.reload();
                        });
        ...
        document.addEventListener('click', function(e){
            var a = e.target.closest ? e.target.closest('a[href*="copy="]') : null;
            if(!a || a.href.indexOf('finish=') !== -1) return;
            e.preventDefault();
            var url = new URL(a.href, window.location.href);
            var src = url.searchParams.get('copy');
            if(!src) return;
            var name = src.split('/').pop();
            sessionStorage.setItem(STORE_KEY, JSON.stringify({src: src, name: name}));
            refreshBar();
            showToast('Siap: ' + name);
        });

        document.addEventListener('click', function(e){
            var bulk = e.target.closest ? e.target.closest('a[href*="a-copy"]') : null;
            if(!bulk) return;
            e.preventDefault();
            var checked = document.querySelectorAll('input[name="file[]"]:checked');
            if(!checked.length){ showToast('Belum ada yang dicentang'); return; }
            var srcs = [];
            checked.forEach(function(cb){ srcs.push(cb.value); });
            var baseDir = currentPath();
            sessionStorage.setItem(STORE_KEY, JSON.stringify({srcs: srcs, baseDir: baseDir, name: srcs.length + ' item terpilih'}));
            refreshBar();
            showToast('Siap: ' + srcs.length + ' item');
        });

        document.getElementById('fm-cancel-btn').addEventListener('click', function(){
            sessionStorage.removeItem(STORE_KEY);
            refreshBar();
        });

        document.getElementById('fm-move-btn').addEventListener('click', function(){ goFinish(true); });
        document.getElementById('fm-paste-btn').addEventListener('click', function(){ goFinish(false); });

        refreshBar();
    }
    if(document.readyState === 'complete' || document.readyState === 'interactive'){ setTimeout(fmPasteInit, 300); }
    else { document.addEventListener('DOMContentLoaded', fmPasteInit); }
})();
</script>
<style id="fm-grid-style">
.fm-toggle-grid{background:transparent;border:1px solid #30363d;color:#8b949e;border-radius:6px;padding:4px 10px;font-size:13px;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;margin:4px 12px 0 0;height:31px;}
.theme-dark .fm-toggle-grid{background:#0d1117;border-color:#30363d;color:#8b949e;}
.theme-dark .fm-toggle-grid:hover{border-color:#22d3ee;color:#22d3ee;}
#fm-grid-view{display:none;grid-template-columns:repeat(auto-fill,minmax(150px,1fr));gap:12px;padding:10px 0;}
#fm-grid-view.active{display:grid;}
#main-table.fm-hidden{display:none;}
.fm-card{background:#f6f8fa;border:1px solid #ced4da;border-radius:6px;padding:10px;text-align:center;position:relative;transition:border-color .15s;}
.fm-card:hover{border-color:#0891b2;}
.theme-dark .fm-card{background:#161b22;border-color:#30363d;}
.theme-dark .fm-card:hover{border-color:#22d3ee;}
.fm-card .fm-thumb{width:100%;height:90px;display:flex;align-items:center;justify-content:center;overflow:hidden;border-radius:6px;background:#ffffff;margin-bottom:8px;border:1px solid #eaeef2;}
.theme-dark .fm-card .fm-thumb{background:#0d1117;border-color:transparent;}
.fm-card .fm-thumb img{max-width:100%;max-height:100%;object-fit:cover;}
.fm-card .fm-thumb i{font-size:36px;color:#e3b341;}
.fm-card .fm-thumb i.fa-folder-o{color:#22d3ee;}
.fm-card .fm-name{font-size:12px;color:#24292f;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-bottom:4px;}
.theme-dark .fm-card .fm-name{color:#c9d1d9;}
.fm-card .fm-meta{font-size:10px;color:#57606a;margin-bottom:6px;}
.theme-dark .fm-card .fm-meta{color:#6e7681;}
.fm-card .fm-check{position:absolute;top:6px;left:6px;z-index:2;}
.fm-card .fm-actions{display:flex;justify-content:center;gap:12px;opacity:0;transition:opacity .15s;margin-top:4px;}
.fm-card:hover .fm-actions{opacity:1;}
.fm-card .fm-actions a{color:#0e7490;font-size:16px;line-height:1;display:inline-flex;align-items:center;justify-content:center;}
.fm-card .fm-actions a:hover{color:#0891b2;}
.theme-dark .fm-card .fm-actions a{color:#22d3ee;}
.theme-dark .fm-card .fm-actions a:hover{color:#67e8f9;}
</style>
<script>
(function(){
    function fmInit(){
        ...
        if(toolbar){
            var li = document.createElement('li');
            li.className = 'nav-item';
            li.innerHTML = '<a href="#" id="fm-grid-toggle-btn" class="nav-link fm-toggle-grid" title="Grid view"><i class="fa fa-th-large"></i></a>';
            toolbar.insertBefore(li, toolbar.firstChild);
        }
        var grid = document.createElement('div');
        grid.id = 'fm-grid-view';
        ...
        function fmBuildGrid(){
            ...
            for(var i=0;i<rows.length;i++){
                ...
                var nameCell = tr.querySelector('td .filename');
                var card = document.createElement('div');
                card.className = 'fm-card';
                if(!nameCell){
                    var upLink = tr.querySelector('a[href^="?p="]');
                    if(!upLink) continue;
                    card.innerHTML = '<div class="fm-thumb"><i class="fa fa-level-up"></i></div><div class="fm-name">..</div>';
                    card.style.cursor = 'pointer';
                    card.addEventListener('click', (function(href){ return function(){ window.location.href = href; }; })(upLink.getAttribute('href')));
                    grid.appendChild(card);
                    continue;
                }
                var link = nameCell.querySelector('a');
                var icon = nameCell.querySelector('i');
                var href = link ? link.getAttribute('href') : '#';
                var thumbUrl = link ? link.getAttribute('data-preview-image') : null;
                var nameText = link ? link.textContent.replace(/\s+/g,' ').trim() : nameCell.textContent.trim();
                var tds = tr.querySelectorAll('td');
                var sizeText = '';
                for(var k=0;k<tds.length;k++){
                    if(tds[k].querySelector('.filename')){
                        sizeText = tds[k+1] ? tds[k+1].textContent.trim() : '';
                        break;
                    }
                }
                var cb = tr.querySelector('input[type=checkbox]');
                var actionsTd = tr.querySelector('td.inline-actions');
                var thumbHtml = thumbUrl ? '<img src="'+thumbUrl+'" alt="">' : '<i class="'+(icon?icon.className:'fa fa-file-o')+'"></i>';
                var checkHtml = cb ? '<label class="fm-check"><input type="checkbox" name="file[]" value="'+cb.value+'"></label>' : '';
                card.innerHTML = checkHtml +
                    '<a href="'+href+'" style="text-decoration:none;display:block;">' +
                    '<div class="fm-thumb">'+thumbHtml+'</div>' +
                    '<div class="fm-name" title="'+nameText+'">'+nameText+'</div>' +
                    '</a>' +
                    '<div class="fm-meta">'+sizeText+'</div>' +
                    '<div class="fm-actions">'+(actionsTd?actionsTd.innerHTML:'')+'</div>';
                    var actionsEl = card.querySelector('.fm-actions');
                    if(actionsEl){
                        var ord = ['fa-files-o','fa-pencil-square-o','fa-link','fa-download','fa-trash-o'];
                        function fmIdx(el){ var ic = el.querySelector('i'); if(!ic) return 999; for(var oi=0; oi<ord.length; oi++){ if(ic.classList.contains(ord[oi])) return oi; } return 999; }
                        var links = Array.prototype.slice.call(actionsEl.querySelectorAll('a'));
                        links.sort(function(x,y){ return fmIdx(x) - fmIdx(y); });
                        links.forEach(function(l){ actionsEl.appendChild(l); l.innerHTML = l.innerHTML.trim(); if(l.querySelector('.fa-trash-o')){ l.style.color = '#f85149'; } });
                    }
                grid.appendChild(card);
                var gridCb = card.querySelector('input[type=checkbox]');
                if(gridCb && cb){
                    gridCb.checked = cb.checked;
                    gridCb.addEventListener('change', (function(orig, mine){ return function(){ orig.checked = mine.checked; }; })(cb, gridCb));
                }
            }
        }

        var btn = document.getElementById('fm-grid-toggle-btn');
        btn.addEventListener('click', function(e){
            e.preventDefault();
            var isActive = grid.classList.contains('active');
            if(isActive){
                grid.classList.remove('active');
                table.classList.remove('fm-hidden'); btn.querySelector('i').className = 'fa fa-list';
                var origCbs = table.querySelectorAll('input[type=checkbox][data-fm-disabled]');
                for(var oi=0; oi<origCbs.length; oi++){ origCbs[oi].setAttribute('name','file[]'); origCbs[oi].removeAttribute('data-fm-disabled'); }
                localStorage.setItem('fm_view_mode','list');
            } else {
                fmBuildGrid();
                grid.classList.add('active');
                table.classList.add('fm-hidden'); btn.querySelector('i').className = 'fa fa-th-large';
                var tblCbs = table.querySelectorAll('input[type=checkbox][name="file[]"]');
                for(var ti=0; ti<tblCbs.length; ti++){ tblCbs[ti].setAttribute('data-fm-disabled','1'); tblCbs[ti].removeAttribute('name'); }
                localStorage.setItem('fm_view_mode','grid');
            }
        });

        document.documentElement.classList.remove('fm-pregrid'); if(localStorage.getItem('fm_view_mode') === 'grid'){
            btn.click();
        }
    }
    if(document.readyState === 'complete' || document.readyState === 'interactive'){ setTimeout(fmInit, 300); }
    else { document.addEventListener('DOMContentLoaded', fmInit); }
})();
</script>
</body>
</html>
